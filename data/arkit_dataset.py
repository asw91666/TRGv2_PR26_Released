...
class ARKitDataset(BaseDataset):
    def __init__(self, opt):
        ...
        if self.is_train:
            ...
            # data sampling
            sampling_rate = opt.train_sampling
    ...
    def get_item(self, index):
        ...
        sample = {
            ...
            'align_mat': align_mat.astype(np.float32),
        }
    ...
    def compute_metrics_(self, inference_data):
        ...
        d['nme'] = np.mean(inference_data['nme'])
        d['b_mean'] = np.mean(inference_data['b_mean'])
