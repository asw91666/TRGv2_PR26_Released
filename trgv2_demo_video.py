...
def parse_args():
    ...
    parser.add_argument("--model_path", type=str, default="checkpoint/TRG_PR26/checkpoint-30/state_dict.bin", help="TRG_PR26")
...
def main(args):
    ...
    save_img_dir = demo_video_path.split('.mp4')[0]
