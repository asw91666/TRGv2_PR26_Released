...
def normalize_points2d(points2d, img_shape):
    """
    :param points2d: [0~img_shape-1]
    :param img_shape:
    :return: [-1~1]
    """
    return points2d / img_shape * 2 - 1

def denormalize_points2d(points2d, img_shape):
    """
    :param points2d: [-1~1]
    :param img_shape:
    :return: [0~img_shape-1]
    """
    return (points2d + 1) / 2 * img_shape