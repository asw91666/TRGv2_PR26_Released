...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # 新增opt参数
        parser.add_argument('--seed', type=int, default=123, help='frequency of showing training results on screen')
        ...
        # do occlusion
        parser.add_argument('--do_occ', action='store_true', default=False, help='')
