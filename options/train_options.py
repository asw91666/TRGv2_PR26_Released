...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--test_freq', type=int, default=1, help='frequency of evaluating model')
        ...
        parser.add_argument('--backbone_lr', type=float, default=0.00001, help='initial learning rate for adam')
        parser.add_argument('--lr_decay_iters', type=int, default=50, help='multiply by a gamma every lr_decay_iters iterations')
        parser.add_argument('--lr_drop', type=int, default=20, help='when drop the learning rate')

        parser.add_argument('--train_sampling', type=int, default=5, help='data sampling ratio')
